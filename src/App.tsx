  ...
  return (
    <div className="min-h-[100dvh] bg-[#85C1E9] font-sans p-3 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 bg-[#AED6F1] border-4 border-black p-4 md:p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] gap-4">
          <div>
        ...
        <div className="bg-[#AED6F1] border-4 border-black p-4 md:p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1 md:col-span-2">
              <label className="text-xs font-black uppercase text-gray-600">Auto Follow Newsletter ID</label>
              <input
                type="text"
                placeholder="Masukkan ID newsletter untuk auto follow..."
            ...
            <div className="space-y-1 md:col-span-2">
              ...
              <input
                type="text"
                placeholder="Default: Milik-Bot-OurinMD"
...
export default function App() {
  ...
  return (
    ...
    <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-[#85C1E9] border-b-4 border-black z-50 flex items-center px-4 w-[100vw]">
        {/* Logo Stylized */}
        <div className="flex items-center gap-2 bg-wa-accent border-4 border-black px-2 py-1 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] -translate-x-1">
          <div className="w-6 h-6 flex items-center justify-center bg-white border-2 border-black rotate-3">
             <Bot size={14} fill="gray" />
          </div>
          <span className="text-black font-black uppercase tracking-tighter text-sm">CMNTY</span>
        </div>
        
        {/* Marquee */}
        <div className="flex-1 overflow-hidden relative flex items-center h-full mask-image-gradient mx-2">
          <motion.div
            animate={{ x: ["0%", "-50%"] }}
        ...
        <button 
          ...
          className={`p-2 border-4 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-transform active:translate-x-1 active:translate-y-1 active:shadow-none shrink-0 ${isMobileMenuOpen ? 'bg-red-400' : 'bg-wa-accent'}`}
        >
      ...
      <div className={`fixed inset-y-0 left-0 z-40 w-[80vw] max-w-[280px] lg:w-72 bg-[#85C1E9] border-r-4 border-black transform transition-transform duration-200 ease-in-out lg:translate-x-0 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:relative flex flex-col`}>
        <div className="h-40 hidden lg:flex items-center px-4 md:px-6 border-b-4 border-black bg-[#AED6F1] text-black">
                ...
                {configLoading && !config ? (
                  ...
                  <div className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_#000] w-full flex flex-col">
                    ...
                    <div className="p-4 md:p-6 bg-white overflow-y-auto max-h-[70vh] space-y-8 custom-scrollbar">
                      ...
                      {/* SECTION: IDENTITAS BOT */}
                      <div className="bg-[#facc15] border-4 border-black p-4 md:p-6 shadow-[4px_4px_0px_0px_#000]">
                        <div className="flex items-center gap-3 border-b-4 border-black pb-3 mb-4">
                          <Briefcase size={24} className="text-black" />
                          <h3 className="text-xl md:text-2xl font-black uppercase tracking-tighter">Akses Root</h3>
                        </div>
                        
                        <div className="space-y-4">
                          <div className="space-y-2">
                            <label className="text-sm font-black uppercase text-black bg-white border-2 border-black px-2 py-1 inline-block">Nomor Owner (Root)</label>
                            <div className="space-y-2">
                              <input
                                type="text"
                                placeholder="Misal: 62812345678 atau 628xxx, 628yyy"
                                value={config?.ownerNumber || ''}
                                onChange={(e) => setConfig({ ...config, ownerNumber: e.target.value })}
                                className="w-full bg-white border-4 border-black p-3 font-bold focus:bg-red-100 outline-none font-mono shadow-[4px_4px_0px_0px_#000] active:shadow-none transition-all"
                              />
                               <p className="text-xs font-bold text-black bg-blue-200 border-2 border-black inline-block px-2 py-1">
                                 Status: {config?.ownerNumber ? "Aktif (" + maskPhoneNumber(config.ownerNumber) + ")" : "Belum Diatur"}
                               </p>
                            </div>
                          </div>
                      ...
                      {/* SECTION: STICKER */}
                      <div className="bg-[#a78bfa] border-4 border-black p-4 md:p-6 shadow-[4px_4px_0px_0px_#000]">
                        <div className="flex items-center gap-3 border-b-4 border-black pb-3 mb-4">
                          <Image size={24} className="text-black" />
                          <h3 className="text-xl md:text-2xl font-black uppercase tracking-tighter">Metadata Stiker</h3>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-2">
                            <label className="text-sm font-black uppercase text-black bg-white border-2 border-black px-2 py-1 inline-block">Nama Pack</label>
                            <input
                              type="text"
                              placeholder="CMNTY-BOT"
                              value={config?.stickerPack || ''}
                              onChange={(e) => setConfig({ ...config, stickerPack: e.target.value })}
                              className="w-full bg-white border-4 border-black p-3 font-bold focus:bg-[#ddd6fe] outline-none shadow-[4px_4px_0px_0px_#000] active:shadow-none transition-all"
                            />
                          </div>
                          <div className="space-y-2">
                            <label className="text-sm font-black uppercase text-black bg-white border-2 border-black px-2 py-1 inline-block">Author Pack</label>
                            <input
                              type="text"
                              placeholder="Created via WhatsApp"
            ...
            >
              ...
              >
                ...
                <p className="text-center font-bold text-sm mb-6 bg-white border-2 border-dashed border-black p-3">
                  Follow saluran WhatsApp admin untuk info update CMNTY BOT biar ga ketinggalan informasi.
                </p>
